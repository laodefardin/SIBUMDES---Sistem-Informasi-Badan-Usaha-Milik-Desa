<?php
$halaman = 'Tambah Laporan Kuliner';
...
$tanggal = $_POST['tanggal'];
  ...
  $path = "./kuliner/".$nama_baru;
    // // Proses upload
    if(move_uploaded_file($tmp, $path)){
    echo $query = 'INSERT INTO kuliner (nama, file, tanggal) values("'.$nama.'","'.$nama_baru.'","'.$tanggal.'")';
    $sql = mysqli_query($koneksi,$query) or die(mysqli_error());
    $_SESSION['pesan']='Tambah';
    echo "<script type='text/javascript'>window.location = 'laporan-kuliner'</script>";
    }
  }
    ?>
