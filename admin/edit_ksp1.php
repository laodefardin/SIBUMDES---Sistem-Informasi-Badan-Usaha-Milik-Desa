            ...
            <div class="card">
                <div class="row row-0">
                    <div class="col">
                        ...
                        <?php
                    $query = $koneksi->query("SELECT ksp1.*, anggota.* FROM ksp1 INNER JOIN anggota ON ksp1.id_anggota=anggota.id_anggota WHERE id_ksp1 = '$_GET[id]'");
...
if (isset($_POST['tambah'])){
    ...
    $update = "UPDATE ksp1 SET sdh_pokok='".$sdpokok."', sdh_jasa='".$sdjasa."', totpokok='".$totpokok."', totjasa='".$totjasa."', bulan='".$bln."', tahun='".$tahun."', waktu='".$waktu."' WHERE id_ksp1 = '".$id."' ";
