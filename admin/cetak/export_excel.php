...
$excel->setActiveSheetIndex(0)->setCellValue('D5', "Jasa 1%"); // Set kolom D3 dengan tulisan "JENIS KELAMIN"
...
$sql = mysqli_query($koneksi, "SELECT ksp1.*, anggota.* FROM ksp1 INNER JOIN anggota ON ksp1.id_anggota=anggota.id_anggota  WHERE bulan = '$bln' AND tahun = '$tahun'");
