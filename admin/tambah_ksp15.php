...
if (isset($_POST['tambah'])){
    ...
    echo $query = 'INSERT INTO ksp15 (id_anggota, sdh_pokok, sdh_jasa, totpokok, totjasa, bulan, tahun, waktu) VALUES ("'.$anggota.'","'.$sdpokok.'","'.$sdjasa.'","'.$totpokok.'","'.$totjasa.'","'.$bln.'","'.$tahun.'","'.$waktu.'") ';     
