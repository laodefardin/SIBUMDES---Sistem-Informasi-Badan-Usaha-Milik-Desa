...
if (isset($_POST['tambah'])){
    ...
    $query = "UPDATE anggota_pertamini SET nama='".$nama."', jabatan='".$jabatan."', alamat='".$alamat."', noktp='".$noktp."', nohp='".$nohp."' WHERE id_angpertamini  = '".$id."' ";   

    $proses = $koneksi->query($query);
    if ($proses){
        $_SESSION['pesan'] = 'Tambah';
        echo "<script> document.location.href='./anggota-pertamini';</script>";
        exit;
    }
}
?>
