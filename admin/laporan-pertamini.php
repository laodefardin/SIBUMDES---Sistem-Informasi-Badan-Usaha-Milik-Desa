                        ...
                        <div class="card-body">
                            <h3 class="card-title">Laporan <?= $halaman ?>
                                <a style="text-align: right;" class="btn btn-primary btn-sm offset-md-10"
                                    href="tambah-laporan-pertamini"> <i class="fa fa-plus"></i> Tambah Laporan</a>
                            </h3>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $data['nama']; ?></td>
                                            <td><?= $data['tanggal']; ?></td>
                                            <td> <a href="./pertamini/<?= $data['file']; ?>" target="_blank">Unduh</a></td>
                                            <td>
                                                <a class="icon"
                                                    href="hapuslaporanpertamini?id=<?=$data['id_pertamini'];?>"
