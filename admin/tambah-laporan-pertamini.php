<?php
$halaman = 'Tambah Laporan Pertamini';
...
$tanggal = $_POST['tanggal'];
  ...
  $path = "./pertamini/".$nama_baru;
    // // Proses upload
    if(move_uploaded_file($tmp, $path)){
    echo $query = 'INSERT INTO pertamini (nama, file, tanggal) values("'.$nama.'","'.$nama_baru.'","'.$tanggal.'")';
    $sql = mysqli_query($koneksi,$query) or die(mysqli_error());
    $_SESSION['pesan']='Tambah';
    echo "<script type='text/javascript'>window.location = 'laporan-pertamini'</script>";
    }
  }
    ?>
