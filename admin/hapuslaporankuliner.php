...
if (is_file("./kuliner/" . $data['file']))
    unlink("./kuliner/" . $data['file']);
    
$hapus = "DELETE FROM kuliner WHERE id_kuliner = '$id'";
...
echo "<script> document.location.href='./laporan-kuliner';</script>";
die();
