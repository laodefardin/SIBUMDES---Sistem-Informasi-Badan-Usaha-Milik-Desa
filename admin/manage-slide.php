                        ...
                        <div class="card-body">
                            <h3 class="card-title">Halaman Edit <?= $halaman ?>
                                <a style="text-align: right;" class="btn btn-primary btn-sm offset-md-9"
                                    href="tambahslide"> <i class="fa fa-plus"></i> Tambah Slide</a>
                            </h3>
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $query = $koneksi->query("SELECT * FROM slide");
                                        $nomor = 1;
                                        foreach ($query as $data): ?>
                                        <tr>
                                            <td><?= $nomor; ?></td>
                                            <td><img src="./img/slide/<?= $data['gambar'];?>" width="300" height="100"> </td>
                                            <td>
                                                <a class="icon"
                                                    href="hapusslide?id=<?=$data['id_slide'];?>"
