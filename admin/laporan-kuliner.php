                        ...
                        <div class="card-body">
                            <h3 class="card-title">Laporan <?= $halaman ?>
                                <a style="text-align: right;" class="btn btn-primary btn-sm offset-md-10"
                                    href="tambah-laporan-kuliner"> <i class="fa fa-plus"></i> Tambah Laporan</a>
                            </h3>
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $query = $koneksi->query("SELECT * FROM kuliner");
                                        $nomor = 1;
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $data['nama']; ?></td>
                                            <td><?= $data['tanggal']; ?></td>
                                            <td> <a href="./kuliner/<?= $data['file']; ?>" target="_blank">Unduh</a></td>
                                            <td>
                                                <a class="icon"
                                                    href="hapuslaporankuliner?id=<?=$data['id_kuliner'];?>"
