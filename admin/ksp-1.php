...
?>
                    ...
                    <div class="form-footer">
                        ...
                        <a style="text-align: right;" class="btn btn-danger btn-sm" href="ksp-1">Refresh</a>
                    </div>
                        ...
                        <div class="card-body">
                            <h3 class="card-title">Halaman Edit <?= $halaman ?>
                                <a style="text-align: right;" class="btn btn-primary btn-sm offset-md-9"
                                    href="tambah_ksp1"> <i class="fa fa-plus"></i> Tambah KSP 1%</a>
                            </h3>
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $query = $koneksi->query("SELECT ksp1.*, anggota.* FROM ksp1 INNER JOIN anggota ON ksp1.id_anggota=anggota.id_anggota"); 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="icon" href="hapusksp1?id=<?=$data['id_ksp1'];?>"
                                                ...
                                                <a class="icon" href="edit_ksp1?id=<?=$data['id_ksp1'];?>"><svg
                                                        xmlns="http://www.w3.org/2000/svg" class="icon" width="24"
                                                        height="24" viewBox="0 0 24 24" stroke-width="2"
                                                        stroke="currentColor" fill="none" stroke-linecap="round"
                                                        stroke-linejoin="round">
...
echo "<script>window.open('cetak/export_pdf.php', '_blank');</script>";
}
?>
...
$_SESSION["bln"] = $_POST['bln'];
$_SESSION["tahun"] = $_POST['tahun'];
echo "<script>window.open('cetak/export_excel.php', '_blank');</script>";
}
?>
